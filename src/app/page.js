  ...
  return (
    <main className="bg-gray-900 min-h-screen overflow-x-hidden">
      ...
      <div className="fixed top-0 left-0 w-full z-50 bg-gray-900/90 backdrop-blur-md shadow-lg">
        <div className="max-w-4xl mx-auto p-3 sm:p-4 flex flex-col sm:flex-row items-center justify-center text-center">
        ...
        {/* ===== TAB MENU STICKY ===== */}
        <div className="w-full bg-gray-800/70 backdrop-blur-md py-2 px-2 flex flex-wrap justify-center gap-2 sm:gap-3 shadow-inner">
          {[
      ...
      {/* ===== CONTENT ===== */}
      <div className="pt-[140px] p-2 sm:p-4 flex justify-center">
